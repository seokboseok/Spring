	...
	<div class="container">
		...
		<main>
			...
			<div class="notice_footer">
				...
				<ul>
					<a
						href="notice?pageNumber=${noticeBean.startPage - 1 eq 0 ? 1 : noticeBean.pageNumber - 1 }"><li><i
							class="fas fa-arrow-circle-left"></i></li></a>

					<c:forEach var="i" begin="${noticeBean.startPage }"
						end="${noticeBean.endPage }">
						<a href="notice?pageNumber=${i }"><li>${i }</li></a>
					</c:forEach>

					<a
						href="notice?pageNumber=${noticeBean.totalPage eq noticeBean.pageNumber ? noticeBean.totalPage : noticeBean.pageNumber + 1 }"><li><i
